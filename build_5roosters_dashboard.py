...
<nav>
  ...
  <button class="refresh-btn" id="refreshBtn" style="margin-left:auto" onclick="startRefresh()">
    <span id="refreshIcon">🔄</span> <span id="refreshLabel">Refresh Data</span>
  </button>
